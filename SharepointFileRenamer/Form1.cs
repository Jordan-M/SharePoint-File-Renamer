...
namespace SharepointFileRenamer
{
    public partial class UserInterface : Form
    {
        ...
        {
            Directory.CreateDirectory(root + "\\AutoGeneratedTest");
            Directory.CreateDirectory(root + "\\AutoGeneratedTest\\A");
            Directory.CreateDirectory(root + "\\AutoGeneratedTest\\B");
            Directory.CreateDirectory(root + "\\AutoGeneratedTest\\C");

            File.Create(root + "\\AutoGeneratedTest\\A\\$& @#");
            File.Create(root + "\\AutoGeneratedTest\\A\\_____");
            File.Create(root + "\\AutoGeneratedTest\\A\\$& @#");

            File.Create(root + "\\AutoGeneratedTest\\A\\Super Secure File!.txt", 1024, FileOptions.None, new FileSecurity());
        }
    }
}
